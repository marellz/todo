<template>
  ...
  >
    <template v-if="task.delete">
      <div class="list--item-deletable">
        <div class="list--item-delete">
          <trash-icon size="15" />
          <span class="d-block ml-3 mt-1">Task deleted.</span>
          <button @click="emitEvadeDelete" class="btn ml-auto font-weight-semibold text-info">Undo</button>
        </div>
